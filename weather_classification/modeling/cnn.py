...
class CNN_V3_reg_v2(nn.Module):
    def __init__(self, input_dim, num_classes=11, p_conv=0.15, p_fc=0.4):
        super(CNN_V3_reg_v2, self).__init__()
        self.p_conv = p_conv   # Convolutional layers
        self.p_fc = p_fc      # Fully connected layers
